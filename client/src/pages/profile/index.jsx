...
import { ADD_PROFILE_IMAGE_ROUET, UPDATE_PROFILE_ROUTE,HOST, REMOVE_PROFILE_IMAGE } from "@/utils/constants";
const Profile = () => {
  ...
  const handleImageChange = async (event)=>{
    ...
    if(file){
      ...
      const response = await apiClient.post(ADD_PROFILE_IMAGE_ROUET,formData,{withCredentials: true});
          ...
          <div className="flex min-w-32 md:min-w-64 flex-col gap-5 text-white items-center justify-center">
            <div className="w-full">
              <Input
                ...
                className=" text-white rounded-lg p-6 bg-[#2c2e3b]"
              />
            </div>
            <div className="w-full">
              <Input
